...
namespace MvcMusicStore.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		private PerformanceCounterHelper.CounterHelper<Counters> counter =
			PerformanceCounterHelper.PerformanceHelper.CreateCounterHelper<Counters>("MusicStore");
		...
		public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
		{
			if (ModelState.IsValid)
			{
				...
				if (user != null)
				{
					...
					counter.Increment(Counters.LogIn);
		...
		public ActionResult LogOff()
		{
			...
			counter.Increment(Counters.LogOff);
